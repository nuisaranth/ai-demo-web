...
> ⚠️ **ข้อควรรู้:** ข้อมูลที่ตั้งค่า (GA4 ID, บทความ, SEO) จะถูกจำไว้เฉพาะ **"เครื่อง/เบราว์เซอร์ที่คุณใช้ตั้งค่าตอนนั้น"** เท่านั้น เหมือนตั้งค่าไว้ในเครื่องนั้นเครื่องเดียว — ถ้าไปเปิดเว็บด้วยคอมเครื่องอื่น มือถือ หรือเบราว์เซอร์อื่น จะต้องตั้งค่าใหม่ทั้งหมด และถ้า deploy เว็บใหม่อีกครั้งก็ต้องตั้งค่าใหม่เช่นกัน
...
> สำหรับผู้สอน/นักพัฒนาที่ต้องการแก้โค้ดเท่านั้น — **นักเรียนไม่จำเป็นต้องทำขั้นตอนนี้** เพราะใช้งานผ่านเว็บที่ deploy แล้ว + หน้า `/admin` ได้เลย
